...
from dependecy import get_tasks_repo, get_tasks_service
...
def Create_new_task(new_task: TaskSchema, task_repository: Annotated[TaskRepository, Depends(get_tasks_repo)]):
